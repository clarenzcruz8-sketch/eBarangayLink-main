    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        if (videoPlayOverlay && demoVideo) {
          ...
          // Click on play button specifically
          if (videoPlayBtn) {
          ...
          demoVideo.addEventListener("pause", function () {
            // Only show overlay if video is at beginning or end
          ...
          videoPlayOverlay.addEventListener("keydown", function (e) {
          ...
          videoPlayOverlay.setAttribute("tabindex", "0");
          videoPlayOverlay.setAttribute("role", "button");
          videoPlayOverlay.setAttribute("aria-label", "Play demo video");
        }
      ...
      function animateCounter(element) {
        ...
        const counter = setInterval(() => {
          ...
          element.textContent =
            displayValue + (isPlusSign ? "+" : "") + (isPercentage ? "%" : "");
        }, frameTime);
      }
